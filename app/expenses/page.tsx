...
export default function ExpensesPage() {
  ...
  return (
    <div>
      ...
      {editing && (
        <div className="fixed inset-0 z-50 bg-black/55 backdrop-blur-md flex items-end sm:items-center justify-center p-4 animate-fade-in" onClick={() => !saving && setEditing(null)}>
          <div
